...
7. 进入“文档审阅”，点击右侧风险项，展示文档预览中的证据行定位和高亮。
8. 进入“字段核对”，展示 eFlow 值、文档提取值和系统结论。
9. 进入“模板差异”，展示模板基准、提交材料和差异分类。
10. 进入“配置中心”，展示模板区块、检查类型和 AI 复核开关。
11. 点击“刷新案例状态”，展示 10 个场景都可批量验证，其中包含 Word、PDF 和图片材料。
